    ...
    <NavigationContainer>
      <Stack.Navigator initialRouteName={location === NO_LOCATION_SET ? "Settings" : "Main"}> 
        <Stack.Screen name="Main" component={MainScreen} initialParams={{ location: location }} options={({ route, navigation }) => ({
          ...
          />
        <Stack.Screen name="Settings" component={SettingsScreen} options={{title: 'Select Location', headerShadowVisible: false, headerBackTitleVisible: false, headerTitleStyle: {fontFamily: 'SpaceMono-Regular', fontSize: 32, color: 'white'}, headerStyle: {backgroundColor: 'blue'}}} />
        <Stack.Screen name="About" component={AboutScreen} options={{title: 'About',  headerShadowVisible: false, headerBackTitleVisible: false, headerTitleStyle: {fontFamily: 'SpaceMono-Regular', fontSize: 32, color: 'black'}, headerStyle: {backgroundColor: 'white'}}} />
      </Stack.Navigator>
    </NavigationContainer>
  );
};
